...
export repo_id=multi_task
export base_raw_dir=datasets
export config_name=pi05_cobot_multi_task
...
if [ "$DO_STEP1" -eq 1 ]; then
    ...
    uv run examples/mobile_aloha_AgileX/convert_aloha_data_to_lerobot_multi.py --base_raw_dir $base_raw_dir --repo_id $repo_id
    echo "步骤1完成"
else

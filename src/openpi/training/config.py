...
class TrainConfig:
    ...
    #         if self.resume:
    #             # 允许但警告：覆盖目录但从检查点恢复
    #             print("Warning: Output directory will be cleared, but training resumes from checkpoint.")
    #         else:
    #             # 覆盖目录且重新开始训练
    #             print("Info: Starting fresh training, output directory will be cleared.")

    ...
    return _policy.Policy(
        ...
        output_transforms=[
            ...
            *data_config.data_transforms.outputs,
            transforms.OptimizeActionsQP(dt=0.033, w_data=1.0, w_acc=100.0, w_jerk=100.0, fix_ends=False, verbose=False),  # dt = 0.02 for 50HZ
            # transforms.OptimizeActionsBSpline(k=3, n_ctrl=10, verbose=False),

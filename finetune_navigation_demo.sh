...
export repo_id=navigation_demo
export raw_dir=datasets/navigation_demo
export config_name=pi05_mobile_cobot_navigation_demo
...
if [ "$DO_STEP1" -eq 1 ]; then
    ...
    uv run examples/mobile_aloha_AgileX/convert_nav_aloha_data_to_lerobot.py --raw_dir "$raw_dir" --repo_id "$repo_id"
    echo "步骤1完成"
else

...
uv run scripts/serve_policy.py \
    ...
    policy:checkpoint --policy.config=pi05_cobot_screw_sorting_single --policy.dir=/home/xlk/work/openpi/checkpoints/pi05_cobot/pi05_cobot_screw_sorting_single/29999 \

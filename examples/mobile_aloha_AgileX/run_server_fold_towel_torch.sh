...
uv run scripts/serve_policy.py \
    ...
    policy:checkpoint --policy.config=pi05_cobot_fold_towel --policy.dir=/home/xlk/work/openpi/checkpoints/pi05_cobot/pi05_cobot_fold_towel/checkpoint-90k-converted 
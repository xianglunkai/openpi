...
uv run scripts/serve_policy.py \
    ...
    policy:checkpoint --policy.config=pi05_cobot_screw_sorting --policy.dir=/home/xlk/work/openpi/checkpoints/pi05_cobot/pi05_mobile_cobot_screw_sorting/030000 \

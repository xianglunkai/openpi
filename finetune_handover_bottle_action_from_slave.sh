...
export repo_id=handover_bottle_action_from_slave
# export raw_dir=datasets/handover_bottle_action_from_slave
export config_name=pi05_cobot_handover_bottle_action_from_slave
